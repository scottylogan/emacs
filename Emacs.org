...
Trying out [[https://xenodium.com/][Xenodium]]'s [[https://melpa.org/#/agent-shell][agent-shell]]

#+begin_src emacs-lisp
  ;; set shell-maker root path for internal shell files
  (setq shell-maker-root-path scotty/local-state-dir)
  ;; agent-shell for AI ACP tools
